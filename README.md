...
To instlall the ICEPAY PHP SDK, run the following command:

```shell
composer require icepay/php-sdk
```
...
```shell
composer require icepay/php-sdk nyholm/psr7 symfony/http-client
```
